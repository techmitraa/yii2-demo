 ...
 */
class CountriesController extends ParentController
{
    /**
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::getAlias('@country_add_message'));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::getAlias('@country_update_message'));
            return $this->redirect(['index']);
        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', Yii::getAlias('@country_delete_message'));
        return $this->redirect(['index']);
    }
