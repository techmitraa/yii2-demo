                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            [
                                ...
                                {
                                    return Common::templateUpdateButton(Yii::$app->urlManager->createUrl(["countries/update", 'id'=> $model->id]), $model);
                                },
                                'delete'=> function ($url, $model)
                                {
                                    return Common::templateDeleteButton($url, $model, Yii::getAlias('@country_delete_confirmation_message'));
                                }
                            ],
                        ],
                    ],
