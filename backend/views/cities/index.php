                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            [
                                ...
                                {
                                    return Common::templateUpdateButton(Yii::$app->urlManager->createUrl(["cities/update", 'id'=> $model->id]), $model);
                                },
                                'delete'=> function ($url, $model)
                                {
                                    return Common::templateDeleteButton($url, $model, Yii::getAlias('@city_delete_confirmation_message'));
                                }
                            ],
                        ],
                    ],
