...
/* @var $searchModel common\models\SmtpSettingsSearch */
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            [
                                ...
                                {
                                    return Common::templateUpdateButton(Yii::$app->urlManager->createUrl(["smtp-settings/update", 'id'=> $model->id]), $model);
                                },
                                'delete'=> function ($url, $model)
                                {
                                    return Common::templateDeleteButton($url, $model, Yii::getAlias('@smtp_delete_confirmation_message'));
                                },
