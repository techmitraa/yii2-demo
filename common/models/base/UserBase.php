...
{
        return [
            [['user_role_id', 'first_name', 'last_name', 'email', 'password', 'dob', 'gender', 'street_address', 'city_id', 'state_id', 'zipcode', 'country_id', 'mobile_number', 'profile_pic', 'is_seller', 'is_newsletter_subscribed', 'is_active'], 'required'],
